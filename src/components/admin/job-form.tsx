    ...
    <form action={onSubmit} className="space-y-6">
      ...
      {job.documentRequirements.length > 0 ? (
        <fieldset className="rounded-lg border border-border p-4">
          ...
          <p className="mt-1 text-sm text-muted">New jobs start with passport bio, photo, and CV. Toggle required on existing files.</p>
        ...
        <p className="text-sm text-muted">
          Saving a new job creates passport bio, passport photo, and CV requirements. You can mark them optional after the first save.
        </p>
      )}
